...
# docker build -t sttp .
# docker run --network=external_default -v ${PWD}:/app -p 3000:3000 -it --name sttp_service -e TEST_CONTRACT_ADDRESS=0x062492AE9FE210B47957B69E59aA26ba8386d4C3 sttp
