...
library Authorizer {
    ...
    function getAuthorizer(Sharing.DataAuthorizer storage self, address _approver, uint _index) internal view returns (address authorizer, Sharing.ScheduleType authorizerType) {
        if(_index > 0) {
