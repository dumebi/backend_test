...
library Authorizer {
    ...
    function _addAuthorizer_(Sharing.DataAuthorizer storage self, address _approver, Sharing.ScheduleType _type) internal returns (bool) {
    ...
    function _isAuthorizer_(Sharing.DataAuthorizer storage self, address _approver) internal view returns (bool) {
        return self.authorizerToIndex[_approver].isUnique;
    }
    
    function _getAuthorizer_(Sharing.DataAuthorizer storage self, address _approver) internal view returns (address authorizer, Sharing.ScheduleType authorizerType) {
    ...
    // function _removeAuthorizer_(Sharing.DataAuthorizer storage self, address _approver) internal returns (bool) {
