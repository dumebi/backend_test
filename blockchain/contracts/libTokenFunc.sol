...
library TokenFunc {
    ...
    // function _getRecordByCat_(Sharing.DataToken storage self, address _holder, Sharing.TokenCat _sitCat, uint _catIndex) internal view returns (uint256 amount, uint256 dateAdded, uint256 duration, bool isMovedToTradable, bool isWithdrawn) {
    ...
    function _addShareholder_(Sharing.DataToken storage self, address _holder, bool _isEnabled, bool _isWithhold) internal returns(string memory success) { 
    ...
    function _getShareHolder_(Sharing.DataToken storage self, address _holder) internal view returns(bool isEnabled, bool isWithhold, uint tradable, uint allocated, uint vesting, uint lien ) { 
    ...
    // function _updateShareHolder_(Sharing.DataToken storage self, address _holder, bool _isEnabled, bool _isWithhold) internal returns(string memory success) { 
